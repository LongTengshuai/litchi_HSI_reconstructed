...
target_folder = 'E:\Hyperspectral_recovery\data\XJF\mat\test_hsi\';  % 替换为目标文件夹路径
target_folder2 = 'E:\Hyperspectral_recovery\data\XJF\mat\test_excel\';  % 替换为目标文件夹路径

qwer = [];
% 遍历图像编号范围：001 到 740
for img_num = 741:1050
    % 构造完整的图像文件名
...
% 设置目标文件夹路径
target_folder = 'E:\Hyperspectral_recovery\data\XJF\mat\test_excel\';
target_folder3 = 'E:\Hyperspectral_recovery\data\XJF\mat\';
...
output_file = fullfile(target_folder3, 'combined_excel.xlsx');
