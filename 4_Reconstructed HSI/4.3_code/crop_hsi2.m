...
% 定义源文件夹和目标文件夹路径
source_folder = 'E:\Hyperspectral_recovery\data\XJF\mat\result_原始数据\';  % 替换为你的源文件夹路径
target_folder = 'E:\Hyperspectral_recovery\data\XJF\mat\result_重建数据\ori';  % 替换为目标文件夹路径
